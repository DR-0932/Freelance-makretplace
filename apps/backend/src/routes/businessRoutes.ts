...
import { createProject, getProjects, getProjectProposals, acceptProposal, createProposal } from "../controllers/businessControllers.js";
...
business_router.post('/projects/:projectId/proposals', authMiddleware, createProposal);
